    ...
    return (
        <Html lang="en">
            <Head>
                ...
                <meta
                    name="description"
                    content="Passionate 🌐 Full Stack Web Developer pursuing B.Tech in 🤖 AI & Machine Learning at 🎓 Vivekanand Institute. Dedicated to evolving skills, 🐧 Linux enthusiast, and open-source advocate."
                />
